...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    final public const ROLE_PARTNER = 'ROLE_PARTNER';
    ...
    {
        return $this->resetPasswordToken !== null && $this->resetPasswordTokenExpiresAt !== null && $this->resetPasswordTokenExpiresAt > new \DateTimeImmutable();
    }
}
